...
function variables() {
  ...
  console.log(`There are ${HOURS_PER_DAY} hours in a day.`)
...
// ########################
// **evenOnly** Write a function that given an array of integer of any length, removes
//     the odd numbers, and returns a new array of just the the even numbers.

function evenOnly(intArray){
  let newArray = [];
