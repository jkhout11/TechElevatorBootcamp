...
public class JdbcUserDao implements UserDao {
    ...
    public Map<String, String> getPasswordAndSaltByUsername(String username) {
        ...
        //BAD-DANGEROUS CODE - VULNERABLE TO SQL INJECTION ATTACKS =================================
        //String sqlSearchForUser = "SELECT salt, password FROM users WHERE UPPER(username) = '" + username.toUpperCase() + "';";
        //SqlRowSet results = jdbcTemplate.queryForRowSet(sqlSearchForUser);
        //==========================================================================================

        //GOOD CODE - ? Prepared/Parameterized SQL STATEMENTS PREVENT SQL INJECTION ATTACKS! =======
