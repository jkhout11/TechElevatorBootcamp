...
public class Lecture {
	...
	//Extended material - will review this in a later lecture (do not go down the rabbit hole)
//	public static void main(String[] args) {
//		Lecture app = new Lecture();
//		System.out.println(app.returnTrueWhenGreaterThanFive(6));
//	}
