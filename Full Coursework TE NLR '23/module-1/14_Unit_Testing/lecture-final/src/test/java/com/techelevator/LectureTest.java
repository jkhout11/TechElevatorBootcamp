...
public class LectureTest {
	...
	@Test
	public void test_middle_way() {
		//Arrange
		Lecture lectureLoopsArrEx = new Lecture();
		int[] a = {1, 2, 3};
		int[] b = {4, 5, 6};
		int[] expectedResult = {2, 5};

		//Act
		int[] actualResult = lectureLoopsArrEx.middleWay(a, b);

		//Assert
		Assert.assertArrayEquals("Expected {2,5}" ,expectedResult, actualResult);
	...
	public void test_first_two(){
		...
		//2. Act
		String actual = lectureStringEx.firstTwo(provided);
