...
public class Exercises {
	...
	public String extraEnd(String str) {
		String charResult = str.substring(str.length() - 2);
		String result = charResult + charResult +charResult;
		return result;
	}
	...
	public boolean endsLy(String str) {
		...
		if(length < 2)
			return false;
		return (str.substring(length -2).endsWith("ly"));
	}
	...
	public boolean hasBad(String str) {
		...
		if (str.length() == 3) return str.substring(0, 3).endsWith("bad");
		return str.substring(0, 3).endsWith("bad")
				|| str.substring(1, 4).endsWith("bad");
	}
