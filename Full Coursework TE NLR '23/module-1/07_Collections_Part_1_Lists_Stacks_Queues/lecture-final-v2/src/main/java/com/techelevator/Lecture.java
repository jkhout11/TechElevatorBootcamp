...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		System.out.println("####################");
		System.out.println("Lists can be populated FROM an array");
		System.out.println("####################");

		List<String> matrixNames = new ArrayList<String>();
		String[] items = {"Neo", "Trinity", "Morpheus"};
		matrixNames.addAll(Arrays.asList(items));
		//matrixNames.addAll(Arrays.asList(new String[]{"Neo", "Trinity", "Morpheus"} ));

		for (int i = 0; i < matrixNames.size(); i++) {
			System.out.println(matrixNames.get(i));
		}
